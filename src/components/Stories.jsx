          ...
          <Splide options={splideOptions}>
            {news.map((val, i) => (
              <SplideSlide key={i} className="mb-0.5">
                <div className="relative gird items-center gap-4 rounded-lg pb-2 shadow shadow-slate-200 ring-1 ring-slate-200">
                  ...
                  <div className="grid items-center justify-items-start px-4 mt-3">
